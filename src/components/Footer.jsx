    ...
    <footer className="footer">
      <div className="container">
        <div className="footer-grid">
          <div className="footer-brand">
            <div className="footer-logo">
              ...
              <span className="logo-text">Resource<span>Hub</span></span>
            </div>
            <p className="footer-description">
              Share and discover educational resources with the community.
          ...
          <div className="footer-links">
            ...
            <ul>
              ...
              <li><Link to="/top-downloads">Top Downloads</Link></li>
            </ul>
          </div>
        ...
        <div className="footer-bottom">
          <span>© {currentYear} ResourceHub. All rights reserved.</span>
